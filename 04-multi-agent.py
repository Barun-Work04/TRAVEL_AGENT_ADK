...
# ── PARALLEL TEAM: Runs all 3 specialists simultaneously ──────────
# ParallelAgent fires all sub-agents at the same time.
# This is the key multi-agent concept in this project.
...
# ── ROOT AGENT: Orchestrates the full plan ────────────────────────
# This is the agent the user talks to.
# It delegates to ResearchTeam, waits for results, then assembles the plan.
root_agent = Agent(
    model=MODEL,
...
if __name__ == "__main__":
    # Change this query to test any destination
